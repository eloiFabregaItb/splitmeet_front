                ...
                <main className="box" >
                    ...
                    <form noValidate onSubmit={onSubmit} className="event_form">
                        <div className="form-container">
                            <label className="newevent__text" htmlFor="name">event Name</label>
                            ...
                            <div className="add_image">
                                <label className="newevent__text" htmlFor="event_image">event Image</label>
                            ...
                            <div className="newevent__members">
                                ...
                                <label className="newevent__text" htmlFor="event_members">event members</label>
                            ...
                            <Button className="newevent_form_btn newevent_form_btn--login" text="SUBMIT" />
                        </div>
                    </form>
